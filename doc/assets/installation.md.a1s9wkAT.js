...
<span class="line"><span style="color:#24292e;">    |               </span></span>
<span class="line"><span style="color:#24292e;">    |---components</span></span></code></pre></div><h2 id="contenu-du-projet" tabindex="-1">Contenu du projet <a class="header-anchor" href="#contenu-du-projet" aria-label="Permalink to &quot;Contenu du projet&quot;">​</a></h2><h3 id="src" tabindex="-1">src <a class="header-anchor" href="#src" aria-label="Permalink to &quot;src&quot;">​</a></h3><p>Dossier principal dans lequel vous allez travailler. Il contient :</p><ul><li>le fichier <code>main.ts</code> qui sert à l&#39;initialisation de VueJS</li><li>le composant root <code>App.vue</code></li><li>un dossier <code>components</code> dans lequel vous allez créer vos composants.</li></ul><h3 id="public" tabindex="-1">public <a class="header-anchor" href="#public" aria-label="Permalink to &quot;public&quot;">​</a></h3><p>Dossier contenant des ressources statiques directement accessible par le navigateur. On y retrouve exclusivement le favicon.ico, le fichier robots.txt et autre fichier accessible depuis la racine de l&#39;URL de votre application.</p><h3 id="index-html" tabindex="-1">index.html <a class="header-anchor" href="#index-html" aria-label="Permalink to &quot;index.html&quot;">​</a></h3><p>Page HTML de démarrage pour la SPA</p><div class="info custom-block"><p class="custom-block-title">INFO</p><p>Les autres fichiers présents à la racine du projets sont divers fichiers de configuration.</p></div>`,21),o=[p];function t(c,r,i,d,u,h){return e(),a("div",null,o)}const v=s(l,[["render",t]]);export{y as __pageData,v as default};
